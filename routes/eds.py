...
async def run_fetch_all_eds(lat, lon):
    ...
    all_urls = [
        ...
        f"{host}/degree_days/freezing_index/{lat}/{lon}/1980/1989",
        f"{host}/degree_days/heating/{lat}/{lon}/1980/1989",
        f"{host}/degree_days/thawing_index/{lat}/{lon}/1980/1989",
        f"{host}geology/point/{lat}/{lon}",
        f"{host}physiography/point/{lat}/{lon}",
        f"{host}permafrost/point/gipl/{lat}/{lon}/2021/2025",
