...
async def run_fetch_all_eds(lat, lon):
    ...
    all_urls = [
        ...
        f"{host}eds/degree_days/freezing_index/{lat}/{lon}/preview",
        f"{host}eds/degree_days/heating/{lat}/{lon}",
        f"{host}eds/degree_days/heating/{lat}/{lon}/preview",
        f"{host}eds/degree_days/thawing_index/{lat}/{lon}",
        f"{host}eds/degree_days/thawing_index/{lat}/{lon}/preview",
        f"{host}geology/point/{lat}/{lon}",
        f"{host}physiography/point/{lat}/{lon}",
        f"{host}eds/permafrost/point/{lat}/{lon}",
    ...
    all_keys = [
        ...
        "snowfall",
        "freezing_index",
        "freezing_index_preview",
        "heating_degree_days",
        "heating_degree_days_preview",
        "thawing_index",
        "thawing_index_preview",
        "geology",
        "physiography",
        "permafrost",
        "wet_days_per_year",
